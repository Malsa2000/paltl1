...
class _ProblemDetailsState extends State<ProblemDetails> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: context.text(
          text: "Report Details", size: 20, color: context.blackColor)),
      body: ListView(
        padding: EdgeInsets.symmetric(horizontal: 16),
        children: [
          context.text(text: "Report's Provider Name",
              size: 14,
          ...
          context.text(text: "Report's Provider Mobile Number",
              size: 14,
              color: context.blackColor,
              wieght: FontWeight.w400),
          ...
          context.text(text: "Report's Tile",
              size: 14,
              color: context.blackColor,
              wieght: FontWeight.w400),
          ...
          context.text(text: "Neighborhode",
              size: 14,
              color: context.blackColor,
              wieght: FontWeight.w400),
          container(name: "Gaza",),
          ...
          Container(
            ...
            child:
            context.text(
                text: "Descroption", size: 20, color: context.greyColor),
          ),
          SizedBox(height: 16.h,),
          ...
          context.text(text: " Description",
              ...
              color: context.blackColor,
              wieght: FontWeight.w400),
          Image(image: AssetImage("images/notfound.png"),
            height: 80.h,
            width: 87.w,),
          SizedBox(height: 16.h,),

          context.text(text: " Report State",
              size: 14,
              color: context.blackColor,
              wieght: FontWeight.w400),
          DropdownButton<int>(
          ...
          Row(children: [
            context.text(text: "Call Report's Provider",
                size: 14,
                color: context.blackColor,
                wieght: FontWeight.w400),
            Spacer(),
            InkWell(
                ...
                child: Image(image: AssetImage("images/call.png"),
                  height: 21.h,
                  width: 21.w,))
          ],),
          ...
          ElevatedButton(style: ElevatedButton.styleFrom(
              ...
              child: context.text(
                  text: "save", size: 14, color: context.wihteColor))
  ...
  Future<void> updataState() async {
    bool update = await ProblemsDbController().update(problem);
    if (update) {
      context.snackBar(massage: "Updata Sucssesfly", error: false);
    }
    context.snackBar(massage: "faild Succsfuly", error: true);
  }

  Problem get problem {
    Problem problem = Problem();
   String title =  _dropMenu[_id!].title;
    problem.state = title;
    return problem;
  }
}
